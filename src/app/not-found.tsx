...
export default function NotFound() {
  ...
  useEffect(() => {
    // Show content after 50 milliseconds
  ...
  return (
    <div className="min-h-screen bg-black text-green-400 font-mono flex flex-col relative">
      <main className={`relative z-10 flex-grow flex flex-col items-center justify-center p-4 gap-8 text-center ${contentVisible ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}>
        <motion.div
